...
{
    internal class PrisonerIncidentWriteRepository : RepositoryWrite<PrisonerIncident>, IPrisonerIncidentWriteRepository
    {
        private readonly PrisonDbContext _context;

        public PrisonerIncidentWriteRepository(PrisonDbContext context) : base(context)
        {
            _context = context;
        }
    }
