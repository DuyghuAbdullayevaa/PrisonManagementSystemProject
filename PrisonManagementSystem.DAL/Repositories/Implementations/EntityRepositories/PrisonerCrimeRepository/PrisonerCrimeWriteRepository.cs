...
{
    internal class PrisonerCrimeWriteRepository: RepositoryWrite<PrisonerCrime>, IPrisonerCrimeWriteRepository
    {
        private readonly PrisonDbContext _context;

        public PrisonerCrimeWriteRepository(PrisonDbContext context) : base(context)
        {
            _context = context;
        }
    }
